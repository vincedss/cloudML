...
loans_application_history_enriched = dataiku.Dataset("loan_applications_live_enriched")
...
# Recipe outputs
loan_applications_features = dataiku.Dataset("loan_applications_live_features")
